...
const createModal = (productData) => {
  ...
  const testingData = {
    ...
    "category": "kitchen",
    "description": "This elegant oak kitchen set offers a perfect blend of style and functionality. It features spacious cabinets, a sturdy countertop, and a built-in island that enhances your cooking experience. The modern design complements any kitchen decor with its warm oak finish.",
    "wood_type": "oak",
    "finish": "medium",
    "dimensions": {
      "depth": 60,
    ...
    "price": 1599.99,
    "weight": 150,
    "image_path": "https://wvxxlssoccbctxspmtyy.supabase.co/storage/v1/object/public/products/public/d848937a-84bf-4c82-902b-9372cd4ada8f.jpeg",
    "stock": 1000,
